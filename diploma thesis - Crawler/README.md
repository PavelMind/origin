...
Класс addrSite содержит URL-адрес страницы в интернете. Он хранит хост, путь страницы и тип протокола(для работы нам важны только http и https).  Метод ref() возвращает true, если адрес указывает именно на страницу сайта.  
...
![стартовая страница поисковика](../additionallyFiles/pochti_googl.png) ![результат запроса](../additionallyFiles/query_result.png)